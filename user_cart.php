    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div style='width:100%;height:15%;line-height:1.2;font-size:1.2vw;text-align:center;display: flex;align-items: center;justify-content: center;'>Общая стоимость: $totalPrice ₽</div>";
