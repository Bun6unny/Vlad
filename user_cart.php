    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<div class='order-font' style='width:95%;margin-left:3%;height:14%;line-height:1.2;text-align:left;display: flex;align-items: center;justify-content: flex-start;'>Оплата: при получении заказа</div>";
