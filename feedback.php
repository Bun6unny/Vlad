...
<body>
    ...
    <div class="title" style="border:none;height:7%;">Обратная связь</div>
    ...
    <div class="feedback">
        ...
        <div class="feedback-center">
            <input type="text" class="feedback-mail" placeholder="...">
            <textarea cols="30" rows="10" class="feedback-message" placeholder="..."></textarea>
            <button class="fb-button">Отправить сообщение</button>
        </div>
        <div class="feedback-side">
            <div class="fb-title">*Ваше сообщение будет рассмотрено, и ответ придет на вашу почту</div>
        </div>
    </div>
