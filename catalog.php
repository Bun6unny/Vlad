...
<body>
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div style='font-size:1.5vw;font-weight:100;margin-left:8%;margin-top:1%;'>Сортировка: <a href='?category=$category&sort=popularity'>По популярности</a> | <a href='?category=$category&sort=price_asc'>Сначала дешевле</a> | <a href='?category=$category&sort=price_desc'>Сначала дороже</a></div>";
