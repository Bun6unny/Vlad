...
<body>
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<div style='font-size:2vw;font-weight:bold;margin-left:8%;'>Сортировка: <a href='?category=$category&sort=popularity'>По популярности</a> | <a href='?category=$category&sort=price_asc'>Сначала дешевле</a> | <a href='?category=$category&sort=price_desc'>Сначала дороже</a></div>";
