...
<?php
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div style='width:20%;height:80%;'><img src='{$row['Image']}' alt='Изображение новости' style='max-width:90%;max-height:90%;border-radius:0.3vw;border:0.1vw solid #EC7088;'></div>";
