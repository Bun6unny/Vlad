...
<?php
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div class='computer-div news-adaptive'><img class='computer-img' src='{$row['Image']}' alt='Изображение новости' style='max-width:95%;max-height:95%;border-radius:0.3vw;border:0.1vw solid #EC7088;'></div>";
